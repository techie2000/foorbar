...
- **Heading Hierarchy**: Headings MUST increment by only one level at a time. Never skip heading levels.
  - ✅ GOOD: `## H2` → `### H3` → `#### H4`
  - ❌ BAD: `## H2` → `#### H4` (skipped H3)
  - Proper heading structure improves both readability and accessibility.

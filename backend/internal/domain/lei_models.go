...
type LEIRecord struct {
	...
	// Legal address
	LegalAddressLine1       string    `gorm:"size:500" json:"legal_address_line_1"`
	LegalAddressLine2       string    `gorm:"size:500" json:"legal_address_line_2"`
	LegalAddressLine3       string    `gorm:"size:500" json:"legal_address_line_3"`
	LegalAddressLine4       string    `gorm:"size:500" json:"legal_address_line_4"`
	...
	HQAddressLine1          string    `gorm:"size:500" json:"hq_address_line_1"`
	HQAddressLine2          string    `gorm:"size:500" json:"hq_address_line_2"`
	HQAddressLine3          string    `gorm:"size:500" json:"hq_address_line_3"`
	HQAddressLine4          string    `gorm:"size:500" json:"hq_address_line_4"`
